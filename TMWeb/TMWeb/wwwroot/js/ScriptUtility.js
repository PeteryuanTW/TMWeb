...
function registerProvider(dotnetHelper) {
...
function setDiagnostics(diagnostics, uri) {
    ...
    diagnostics.forEach(diagnostic => {
        diagnostic.startLineNumber = diagnostic.start.line;

        diagnostic.startColumn = diagnostic.start.character;

        diagnostic.endLineNumber = diagnostic.end.line;

        diagnostic.endColumn = diagnostic.end.character;
        //console.log(diagnostic.startLineNumber + diagnostic.startColumn + diagnostic.endLineNumber + diagnostic.endColumn);
    });
